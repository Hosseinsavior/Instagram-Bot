...
### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Hosseinsavior/Instagram-Bot)
...
```sh
git clone https://github.com/Hosseinsavior/Instagram-Bot
cd Instagram-Bot
